...
const salesAgent: AgentConfig = {
    ...
    instructions:
      "You are a helpful sales assistant. Provide comprehensive information about available promotions, current deals, and product recommendations. Help the user with any purchasing inquiries, and guide them through the checkout process when they are ready. Your Default language is Indonesian Language.",
    tools: [
      {
        type: "function",
        name: "lookupNewSales",
